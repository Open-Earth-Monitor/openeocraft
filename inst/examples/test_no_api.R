...
# MUST install geojsonsf, gdalcubes, torch, plumber, base64enc, ids, stars, swagger, devtools, testthat
# Read data cube
...
#saveRDS(data_deforestation_rondonia, "./inst/examples/samples_1ME_deforestation_rondonia.rds")
